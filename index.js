...
const start = async (client = new Client()) => {
        ...
        client.onAddedToGroup(((chat) => {
            ...
            if (totalMem < 10) { 
            	client.sendText(chat.id, `Hadeh member nya cuma ${totalMem}, Kalo mau invite bot, minimal jumlah mem ada 10`).then(() => client.leaveGroup(chat.id)).then(() => client.deleteChat(chat.id))
            } else {
